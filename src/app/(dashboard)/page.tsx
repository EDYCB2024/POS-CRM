  ...
  return (
    <>
      ...
      <main className="p-lg space-y-lg max-w-[1440px] mx-auto w-full min-h-[calc(100vh-100px)] flex flex-col justify-center">
        {/* Welcome Section */}
        <section className="relative overflow-hidden bg-white border border-outline-variant p-6 sm:p-xl rounded-[32px] md:rounded-[48px] shadow-2xl shadow-primary/5">
          ...
          <div className="relative z-10 py-10">
            <div className="text-center mb-16">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-black tracking-tighter text-on-surface leading-[1.1] mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-lg max-w-5xl mx-auto">
              <Link 
                href="/terminals" 
                className="group p-6 sm:p-xl bg-slate-50/50 border border-outline-variant rounded-[32px] hover:bg-white hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 transition-all duration-500"
              >
              ...
              <Link 
                href="/inventory" 
                className="group p-6 sm:p-xl bg-slate-50/50 border border-outline-variant rounded-[32px] hover:bg-white hover:shadow-2xl hover:shadow-secondary/10 hover:-translate-y-2 transition-all duration-500"
              >
                <div className="flex flex-col items-center text-center">
              ...
              <Link 
                ...
                className="group p-6 sm:p-xl bg-slate-50/50 border border-outline-variant rounded-[32px] hover:bg-white hover:shadow-2xl hover:shadow-tertiary/10 hover:-translate-y-2 transition-all duration-500"
              >
                <div className="flex flex-col items-center text-center">
